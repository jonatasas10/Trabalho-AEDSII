...
int main(){
    ...
    //setlocale(LC_ALL, "Portuguese"); SE ESTIVER NO WINDOWS SÓ DESCOMENTAR E ADICIONAR #include <locale.h>
    ...
    while(op!=-1){
        switch (op){
            ...
            case (6):
                if(crioulistadenomes){
                    printf("GERANDO PARTIÇÕES USANDO O MÉTODO DE SELEÇÃO NATURAL");
                    nParticoes = 0;
